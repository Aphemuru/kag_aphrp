...
void LoadSprites(CSprite@ this)
{
	if(this.getBlob().getTeamNum() == RACE_DWARVES)
		ensureCorrectRunnerTexture(this, "archer_dwarf", "DwarfArcher");
	else if(this.getBlob().getTeamNum() == RACE_ELVES)
		ensureCorrectRunnerTexture(this, "archer_elf", "ElfArcher");
	else if(this.getBlob().getTeamNum() == RACE_ORCS)
		ensureCorrectRunnerTexture(this, "archer_orc", "OrcArcher");
	else if(this.getBlob().getTeamNum() == RACE_UNDEAD)
		ensureCorrectRunnerTexture(this, "archer_undead", "UndeadArcher");
	else
