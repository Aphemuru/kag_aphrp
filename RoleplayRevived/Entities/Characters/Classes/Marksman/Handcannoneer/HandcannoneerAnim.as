...
#include "HandcannoneerCommon.as"
...
void LoadSprites(CSprite@ this)
{
	if(this.getBlob().getTeamNum() == RACE_DWARVES)
		ensureCorrectRunnerTexture(this, "handcannoneer_dwarf", "DwarfHandcannoneer");
	else if(this.getBlob().getTeamNum() == RACE_ORCS)
		ensureCorrectRunnerTexture(this, "handcannoneer_orc", "OrcHandcannoneer");
	else if(this.getBlob().getTeamNum() == RACE_UNDEAD)
		ensureCorrectRunnerTexture(this, "handcannoneer_undead", "UndeadHandcannoneer");
	else
		ensureCorrectRunnerTexture(this, "handcannoneer", "HumanHandcannoneer");
