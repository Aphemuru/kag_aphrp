...
#include "CrystalbowmanCommon.as"
...
void LoadSprites(CSprite@ this)
{
	if(this.getBlob().getTeamNum() == RACE_DWARVES)
		ensureCorrectRunnerTexture(this, "crystalbowman_dwarf", "DwarfCrystalbowman");
	else if(this.getBlob().getTeamNum() == RACE_ELVES)
		ensureCorrectRunnerTexture(this, "crystalbowman_elf", "ElfCrystalbowman");
	else if(this.getBlob().getTeamNum() == RACE_ORCS)
		ensureCorrectRunnerTexture(this, "crystalbowman_orc", "OrcCrystalbowman");
	else if(this.getBlob().getTeamNum() == RACE_UNDEAD)
		ensureCorrectRunnerTexture(this, "crystalbowman_undead", "UndeadCrystalbowman");
	else
		ensureCorrectRunnerTexture(this, "crystalbowman", "Crystalbowman");
