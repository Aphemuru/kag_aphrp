...
bool shouldPickup(CBlob@ blob)
{
    ...
    return name == "mat_gold" || name == "mat_stone" || name == "mat_wood" || name == "mat_flour" ||
	       name == "mat_coal" || name == "mat_iron" || name == "mat_aetheryte" || name == "mat_mythril" || name == "mat_adamantite" || 
		   name == "mat_ironbars" || name == "mat_steelbars" || name == "mat_goldbars" || name == "mat_crystalbars" || name == "mat_mythrilbars" || name == "mat_adamantbars" ||
		   //name == "leaf" ||
		   name == "grain";
}
