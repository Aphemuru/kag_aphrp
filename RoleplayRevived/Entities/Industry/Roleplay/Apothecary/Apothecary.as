...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem( this, "Potion of Rock Skin", "$potion_rockskin$", "potion_rockskin", "Reduces incoming damage by 25%\nEffect lasts for 15 seconds");
		
		AddRequirement( s.requirements, "coin", "", "Coins", TRADER_POTION_ROCK_SKIN_COST);
	}
	{
		ShopItem@ s = addShopItem( this, "Potion of Regeneration", "$potion_regeneration$", "potion_regeneration", "Heals 1 $heart$ every 4 seconds\nEffect lasts for 20 seconds");
