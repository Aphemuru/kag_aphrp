...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem( this, "Crystal arrows", "$mat_crystalarrows$", "mat_crystalarrows", "Crystal arrows\n\nAmmunition for the Marksman\nAble to pierce through armor and ignore 10 Defence rating (20 with Crystal bow)\nDamage of 1.5" );
		AddRequirement( s.requirements, "coin", "", "Coins", TRADER_ARROW_CRYSTAL_COST);
		AddRequirement( s.requirements, "tech", "Smithing II", "Smithing II", 1);
	}
	{
		ShopItem@ s = addShopItem( this, "Crystal bow", "$crystal_bow$", "crystal_bow", "Crystal bow\n\nA powerful longbow forged from crystal alloy" );
		AddRequirement( s.requirements, "coin", "", "Coins", TRADER_WEAPON_CRYSTAL_BOW_COST);
		AddRequirement( s.requirements, "tech", "Smithing II", "Smithing II", 1);
	}
	{
