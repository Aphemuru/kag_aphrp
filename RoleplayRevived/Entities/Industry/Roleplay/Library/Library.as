...
void onInit( CBlob@ this )
{
	...
	bool nonmortal = this.getTeamNum() == 4 || this.getTeamNum() == 5;
	float costModifier = 0.64f; // 0.64 : 0.8f
	float builderCostModifier = nonmortal || this.getTeamNum() == 1 ? 0.8f : 1.0f;
	float knightCostModifier = nonmortal || this.getTeamNum() == 3 ? 0.8f : 1.0f;
	float archerCostModifier = nonmortal || this.getTeamNum() == 2 ? 0.8f : 1.0f;
	float mageCostModifier = nonmortal || this.getTeamNum() == 0 ? 0.8f : 1.0f;
	
	{
		...
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 500 * costModifier * builderCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 14 * costModifier * builderCostModifier);
		AddRequirement( s.requirements, "not tech", "Smithing I", "Smithing I", 1);
	}
	{
		ShopItem@ s = addShopItem( this, "Builder - Smithing II", "$tech_builder_smithing_2$", "Smithing II", "Further advancements in Smithing allow Blacksmiths to work with Mythril and Crystal");
		s.spawnNothing = true;
		
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 1000 * costModifier * builderCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 43 * costModifier * builderCostModifier);
	...
	{
		ShopItem@ s = addShopItem( this, "Builder - Smithing III", "$tech_builder_smithing_3$", "Smithing III", "Mastery of Smithing allow Blacksmiths to work with Adamant and Gold");
		s.spawnNothing = true;
		
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 2000 * costModifier * builderCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 120 * costModifier * builderCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 250 * costModifier * builderCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 15 * costModifier * builderCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 500 * costModifier * builderCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 40 * costModifier * builderCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 1000 * costModifier * builderCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 105 * costModifier * builderCostModifier);
	...
	{
		ShopItem@ s = addShopItem( this, "Dwarven Sappers", "$tech_builder_mastery$", "Dwarven Sappers", "Unique Dwarf Tech\n\nDwarven Sappers are well armoured and resilient\n\nBuilders are more resistant to damage");
		s.spawnNothing = true;
		
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 3000 * costModifier * builderCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 205 * costModifier * builderCostModifier);
...

	{
		...
		AddRequirement( s.requirements, "coin", "", "Coins", 30 * costModifier * knightCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "coin", "", "Coins", 75 * costModifier * knightCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "coin", "", "Coins", 185 * costModifier * knightCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "coin", "", "Coins", 23 * costModifier * knightCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "coin", "", "Coins", 56 * costModifier * knightCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "coin", "", "Coins", 138 * costModifier * knightCostModifier);
	...
	{
		ShopItem@ s = addShopItem( this, "Orc Elite Knights", "$tech_knight_mastery$", "Orc Elite Knights", "Unique Orc Tech\n\nTrue mastery of Endurance and Shield Gliding\n\nOrc Elite Knights are able to run faster, jump higher, and glide longer");
		s.spawnNothing = true;
		
		AddRequirement( s.requirements, "coin", "", "Coins", 300 * costModifier * knightCostModifier);
...

	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 500 * costModifier * archerCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 20 * costModifier * archerCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 1000 * costModifier * archerCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 55 * costModifier * archerCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 2000 * costModifier * archerCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 145 * costModifier * archerCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 250 * costModifier * archerCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 18 * costModifier * archerCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 500 * costModifier * archerCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 46 * costModifier * archerCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 1000 * costModifier * archerCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 118 * costModifier * archerCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 3000 * costModifier * archerCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 240 * costModifier * archerCostModifier);
...

	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 250 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 250 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 17 * costModifier * mageCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 500 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 500 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 49 * costModifier * mageCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 1000 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 1000 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 133 * costModifier * mageCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 250 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 18 * costModifier * mageCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 250 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 250 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 43 * costModifier * mageCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 500 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 500 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 112 * costModifier * mageCostModifier);
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 2000 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 1000 * costModifier * mageCostModifier);
		AddRequirement( s.requirements, "coin", "", "Coins", 228 * costModifier * mageCostModifier);
