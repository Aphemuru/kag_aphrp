...
void onInit( CBlob@ this )
{
	...
	{
		ShopItem@ s = addShopItem( this, "Placeholder1", "$gold_chestplate$", "gold_chestplate", "Golden chestplate\n\nProtective garment for the Knight\nDefence rating of 65" );
		AddRequirement( s.requirements, "blob", "mat_goldbars", "Gold bars", 16 );
		AddRequirement( s.requirements, "tech", "Smithing III", "Smithing III", 1);
	}
	
	{
		ShopItem@ s = addShopItem( this, "Iron sword", "$iron_sword$", "iron_sword", "Iron sword\n\nA weapon for the Knight\nDamage rating of 1.0" );
	...
	{
		ShopItem@ s = addShopItem( this, "Placeholder2", "$gold_sword$", "gold_sword", "Golden sword\n\nA weapon for the Knight\nDamage rating of 1.5" );
		AddRequirement( s.requirements, "blob", "mat_goldbars", "Gold bars", 8 );
		AddRequirement( s.requirements, "tech", "Smithing III", "Smithing III", 1);
	}
	...
	}
	{
		...
		AddRequirement( s.requirements, "blob", "mat_mythrilbars", "Mythril bars", 1 ); // was mythril
		AddRequirement( s.requirements, "blob", "mat_ironbars", "Iron bars", 2 );
		AddRequirement( s.requirements, "tech", "Smithing II", "Smithing II", 1);
	}
	{
		ShopItem@ s = addShopItem( this, "Placeholder3", "$musket$", "musket", "Musket\n\nA powerful sniping weapon for the Marksman\nRequires round shot" );
		AddRequirement( s.requirements, "blob", "mat_mythrilbars", "Mythril bars", 1 ); // was mythril
		AddRequirement( s.requirements, "blob", "mat_ironbars", "Iron bars", 2 );
		AddRequirement( s.requirements, "tech", "Smithing II", "Smithing II", 1);
	}
	...
	{
		ShopItem@ s = addShopItem( this, "Crystal arrows", "$mat_crystalarrows$", "mat_crystalarrows", "Crystal arrows\n\nAmmunition for the Marksman\nAble to pierce through armor and ignore to 10 Defence rating (20 with Crystal bow)\nDamage of 1.5" );
		AddRequirement( s.requirements, "blob", "mat_crystalbars", "Crystal bars", 1 );
		AddRequirement( s.requirements, "tech", "Smithing II", "Smithing II", 1);
	}
	{
		ShopItem@ s = addShopItem( this, "Crystal bow", "$crystal_bow$", "crystal_bow", "Crystal bow\n\nA powerful longbow forged from crystal alloy" );
		AddRequirement( s.requirements, "blob", "mat_crystalbars", "Crystal bars", 4 );
		AddRequirement( s.requirements, "tech", "Smithing II", "Smithing II", 1);
	}
	{
