...
const u8 crystal_smelt_time = 25;
...
void onInit( CBlob@ this )
{
	...
	{
		ShopItem@ s = addShopItem( this, "Crystal Bar", "$mat_crystalbars$", "mat_crystalbars", "Crystal Bar\n\nCan be used to forge equipment\nSmelting duration of 25 seconds" );
		s.spawnNothing = true;
		
		AddRequirement( s.requirements, "blob", "mat_coal", "Coal", 10 );
		AddRequirement( s.requirements, "blob", "mat_aetheryte", "Aetheryte", 10 );
...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	...
	if (cmd == this.getCommandID("shop made item"))
	{
		...
		this.set_u8("furnace_timer", name == "mat_ironbars" ? iron_smelt_time :
								     ...
								     name == "mat_crystalbars" ? crystal_smelt_time :
